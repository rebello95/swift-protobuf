...
class FileGenerator {
    ...
    private var titleComment: String {
        ...
        case .protobuf:
            ...
            // Original source: \(self.fileDescriptor.name)
            //
            // This file acts represents client models for the above proto definition(s).
            //\n
            """
        case.abstraction:
            return """
            ...
            // Original source: \(self.fileDescriptor.name)
            //
            // This file acts as an abstraction layer between proto definitions and the application layer.
            //\n
            """
        }
    }
    ...
    var outputFilename: String {
        let ext = self.configuration.fileExtension
    ...
    init(fileDescriptor: FileDescriptor, generatorOptions: GeneratorOptions, configuration: ModelConfiguration = .protobuf) {
    ...
    func generateOutputFile(printer p: inout CodePrinter, errorString: inout String?) {
        ...
        let enums = fileDescriptor.enums.map {
            return EnumGenerator(descriptor: $0, generatorOptions: generatorOptions, namer: namer, configuration: self.configuration)
        }
